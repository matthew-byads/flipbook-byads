        ...
        >
            ...
            <div className="flex flex-col gap-2">
                ...
                <button
                    ...
                    className="cursor-pointer mt-3 w-full bg-black text-white py-2 rounded-lg font-medium hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 active:scale-95 duration-100"
                >
