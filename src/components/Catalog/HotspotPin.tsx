        ...
        >
            ...
            {!isArea && (
                <>
                    {hotspot.type === "link" ? (
                        ...
                        <svg className={cn("w-3.5 h-3.5 ml-0.5 fill-current", isAdmin ? "text-white" : "text-black")} viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                    ) : (
                        <div
                            className={cn(
            ...
            {isArea && (
                hotspot.type === "link" ? (
                    ...
                    <svg className={cn("w-6 h-6 opacity-60 fill-current", isAdmin ? "text-red-600" : "text-white")} viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                ) : (
